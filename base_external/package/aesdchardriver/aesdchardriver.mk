...
AESDCHARDRIVER_VERSION = 'f9b18edd48ca27f4325b8ea57d3fb4249f674d1b'
...
define AESDCHARDRIVER_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 0755 $(@D)/aesd-char-driver/aesdchar-start-stop.sh $(TARGET_DIR)/etc/init.d/S99aesdchardriver
endef
